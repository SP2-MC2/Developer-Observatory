...
<div class="row">
    <div class="col-lg-6"  style="text-align: justify;">
        ...
        <p>As part of this study, we will assign you three short Python programming tasks to complete. These should take less than an hour. We ask that you write and test code directly in your browser, in an online Python editor provided for this purpose. After you complete the tasks, you will be directed to a short exit interview.</p>
